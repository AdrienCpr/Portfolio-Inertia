...
const Projects = () => {
    function SampleNextArrow(props: { className: any; style: any; onClick: any; }) {
        ...
        return (
            <div
                className={className}
                style={{...style, display: "block", background: "black", borderRadius: '100%', paddingTop: "1px"}}
                onClick={onClick}
            />
        );
    }
    ...
    const settings = {
        ...
        pauseOnHover: true,
        // focusOnSelect: true,
        nextArrow: <SampleNextArrow className={""} onClick={""} style={{}}/>,
        prevArrow: <SamplePrevArrow className={""} onClick={""} style={{}}/>,
        responsive: [
            {
                breakpoint: 1024,
                settings: {
